export const STAKE_ABI = [{
	...
	"inputs": [{
		...
		"internalType": "struct Staking.pairInfo",
		"name": "_pairInfo",
		"type": "tuple"
	}],
	"name": "addPair",
